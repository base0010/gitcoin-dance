...
export const NFT: React.FC<Props> = () => {
    ...
    const handleNftMint = async(hash:string)=>{
        if(nft.instance){
            ...
            const tx = await nft.instance.mint("0xdeadbeef00000000000000000000000000000000", hash)
            console.log(tx)
        }
    ...
    return (
        <div>
            <h4>Mint NFT</h4>
            <input onChange={(e:ChangeEvent<HTMLInputElement>)=>setNftMintInfo(e.target.value)}/>
