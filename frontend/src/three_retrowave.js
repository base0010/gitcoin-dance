...
import Stats from "three/examples/jsm/libs/stats.module"; // CRT effect
...
export var RetrowaveScene = function (scenePath) {
    ...
    this.textureResolution = 1024; // Could make this dynamically editable later on

    // RESSOURCES
    // You can set all SVG files you want to load in this array...
    this.svgFiles = [
        [`./${this.scenePath}scenery/sun.svg`, 0, 40, -500, 0.5, "sun"],
        // [`./${this.scenePath}scenery/city_far.svg`, 0, 15, -450, 0.05, "cityFar"],
        // [`./${this.scenePath}scenery/city_close.svg`, 0, 28, -300, 0.1, "cityClose"],
    ];
...
// this.pyramidGeometry = undefined;
// this.pyramidInstance = undefined;
// this.pyramidMaterial = undefined;
// this.pyramid = undefined;
// this.pyramidWireframe = undefined;
// this.wireframeMaterial = undefined;
